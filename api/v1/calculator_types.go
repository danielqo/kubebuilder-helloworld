...
type CalculatorSpec struct {
	...
	// ValueA int32 `json:"valueA,omitempty"`
	// ValueB int32 `json:"valueB,omitempty"`
...
// +kubebuilder:printcolumn:name="Values",type="string",JSONPath=".spec.values",description="Total Value"
// +kubebuilder:printcolumn:name="Total",type="integer",JSONPath=".status.totalValue",description="Total Value"
